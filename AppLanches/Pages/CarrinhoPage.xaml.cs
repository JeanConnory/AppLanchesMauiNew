...
public partial class CarrinhoPage : ContentPage
{
    ...
    private async Task<bool> GetItensCarrinhoCompra()
    {
        try
        {
            ...
            {
                await DisplayAlert("Erro", errorMessage ?? "Não foi possível obter os itens do carrinho.", "OK");
                return false;
            }
    ...
    private async void TapConfirmarPedido_Tapped(object sender, TappedEventArgs e)
    {
        ...
        {
            await DisplayAlert("Informação", "Seu carrinho está vazio ou seu pedido já foi confirmado", "OK");
            return;
        }
